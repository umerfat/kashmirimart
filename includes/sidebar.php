        ...
        <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse sidebar-navbar-collapse">
                ...
                <ul class="nav navbar-nav" id="sidenav01">
                    <li class="active">
                        <a href="javascript:void(0)" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed">Cat Sub 1 <span class="caret pull-right"></span>
                        </a>
                        <div class="collapse" id="toggleDemo" style="height: 0px;">
                            <ul class="nav nav-list">
                                <li><a href="item.php">Submenu1.1</a></li>
                                <li><a href="item.php">Submenu1.2</a></li>
                                <li><a href="item.php#">Submenu1.3</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
