                ...
                <ul class="slides clearfix">
                    <li>
                        ...
                        <div class="hero-holder text-center right-align">
                            ...
                            <a href="#" class="btn btn-lg btn-white"><span><!-- Search Labour Of your choice --></span></a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="hero-holder text-center">
                            <div class="hero-lines">
                                <h1 class="hero-heading white large"><!-- We Haunt --></h1>
                            </div>
                            <a href="#" class="btn btn-lg btn-white"><span><!-- Book Labour --></span></a>
                        </div>
                    </li>
                    <li>
